// Amanda Chen - 12/08/19

import java.util.Arrays;
public class IncompleteDominance
{
    private String name;
    private String intermediatePhenotype;
    ...
    public IncompleteDominance(String trait, String intermediate, String other, String inheritance, String mother1, String mother2, String father1, String father2) // creates a trait w/ specific inheritance patterns
    {
        name = trait;
        intermediatePhenotype = intermediate;
    ...
    public String phenotype()
    {
        ...
        return  withCounter + ":" + intermediateCounter + ":" + withoutCounter;
    }
    ...
    public void printInfo() // print parent genotypes, punette square, genotype ratio, phenotype ratio.
    {
        ...
        System.out.println("The phenotype ratio is: " + phenotype() + " (" + name + " :  " + intermediatePhenotype + " : " + otherPhenotype + ")");
    }
